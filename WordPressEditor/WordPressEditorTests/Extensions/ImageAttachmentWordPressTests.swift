...
class ImageAttachmentWordPressTests: XCTestCase {
    ...
    func testAltSetter() {
        ...
        XCTAssertEqual(imageAttachment.extraAttributes["alt"]?.toString(), alt)
    ...
    func testWidthSetter() {
        ...
        XCTAssertEqual(imageAttachment.extraAttributes["width"]?.toString(), String(width))
    ...
    func testHeightSetter() {
        ...
        XCTAssertEqual(imageAttachment.extraAttributes["height"]?.toString(), String(height))
    ...
    func testImageIDChangesExtraAttributes() {
        ...
        XCTAssertEqual(imageAttachment.extraAttributes["class"]?.toString(), "some-attributes some-more-attributes wp-image-200")
        
        imageAttachment.imageID = 400
        XCTAssertEqual(imageAttachment.extraAttributes["class"]?.toString(), "some-attributes some-more-attributes wp-image-400")
    }
    ...
    func testImageIDSetToNilChangesExtraAttributes() {
        ...
        imageAttachment.imageID = nil
        XCTAssertEqual(imageAttachment.extraAttributes["class"]?.toString(), "some-other-class")
    }
}
